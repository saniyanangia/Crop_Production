...
iowa_ndvi_df = data.frame(iowa_ndvi$START.DATE, iowa_ndvi$SAMPLE.VALUE, iowa_ndvi$ANOM.VALUE)
...
iowa_prec$time = format(as.Date(iowa_prec$system.time_start, format = "%b %d, %Y"), "%d/%m/%Y")
iowa_prec_df = data.frame(iowa_prec$time, iowa_prec_values)
...
iowa_lst$time = format(as.Date(iowa_lst$system.time_start, format = "%b %d, %Y"), "%d/%m/%Y")
iowa_lst_df = data.frame(iowa_lst$time, iowa_lst_values)
...
hlj_ndvi$START.DATE = format(as.Date(hlj_ndvi$START.DATE, "%Y-%m-%d"), "%d/%m/%Y")
hlj_ndvi_df = data.frame(hlj_ndvi$START.DATE, hlj_ndvi$SAMPLE.VALUE, hlj_ndvi$ANOM.VALUE)
...
hlj_prec$time = format(as.Date(hlj_prec$system.time_start, format = "%b %d, %Y"), "%d/%m/%Y")
hlj_prec_df = data.frame(hlj_prec$time, hlj_prec_values)
...
hlj_lst$time = format(as.Date(hlj_lst$system.time_start, format = "%b %d, %Y"), "%d/%m/%Y")
hlj_lst_df = data.frame(hlj_lst$time, hlj_lst_values)
...
mg_ndvi$START.DATE = format(as.Date(mg_ndvi$START.DATE, "%Y-%m-%d"), "%d/%m/%Y")
mg_ndvi_df = data.frame(mg_ndvi$START.DATE, mg_ndvi$SAMPLE.VALUE, mg_ndvi$ANOM.VALUE)
...
mg_prec$time = format(as.Date(mg_prec$system.time_start, format = "%b %d, %Y"), "%d/%m/%Y")
mg_prec_df = data.frame(mg_prec$time, mg_prec_values)
...
mg_lst$time = format(as.Date(mg_lst$system.time_start, format = "%b %d, %Y"), "%d/%m/%Y")
mg_lst_df = data.frame(mg_lst$time, mg_lst_values)
...
cdb_ndvi$START.DATE = format(as.Date(cdb_ndvi$START.DATE, "%d/%m/%y"), "%d/%m/%Y")
cdb_ndvi_df = data.frame(cdb_ndvi$START.DATE, cdb_ndvi$SAMPLE.VALUE, cdb_ndvi$ANOM.VALUE)
...
cdb_prec$time = format(as.Date(cdb_prec$system.time_start, format = "%b %d, %Y"), "%d/%m/%Y")
cdb_prec_df = data.frame(cdb_prec$time, cdb_prec_values)
...
cdb_lst$time = format(as.Date(cdb_lst$system.time_start, format = "%b %d, %Y"), "%d/%m/%Y")
cdb_lst_df = data.frame(cdb_lst$time, cdb_lst_values)
...
pltv_ndvi$START.DATE = format(as.Date(pltv_ndvi$START.DATE, "%Y-%m-%d"), "%d/%m/%Y")
pltv_ndvi_df = data.frame(pltv_ndvi$START.DATE, pltv_ndvi$SAMPLE.VALUE, pltv_ndvi$ANOM.VALUE)
...
pltv_prec$time = format(as.Date(pltv_prec$system.time_start, format = "%b %d, %Y"), "%d/%m/%Y")
pltv_prec_df = data.frame(pltv_prec$time, pltv_prec_values)
...
pltv_lst$time = format(as.Date(pltv_lst$system.time_start, format = "%b %d, %Y"), "%d/%m/%Y")
pltv_lst_df = data.frame(pltv_lst$time, pltv_lst_values)
